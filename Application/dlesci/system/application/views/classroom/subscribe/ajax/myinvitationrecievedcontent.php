...
<input type="button" <?php if($page==0) echo 'style="visibility: hidden"'; ?> class="profile_button" value="previous" onclick="loadPage('classroom/myinvitationrecievedcontent/<?php echo ($page-1); ?>', 'list')"/>
            <span class="profile_label"><?php echo $page; ?></span>
            <input type="button" <?php if($page!=0) echo 'style="visibility: hidden"'; ?> class="profile_button" value="next" onclick="loadPage('classroom/myinvitationrecievedcontent/<?php echo ($page+1); ?>', 'list')"/>
</div>
<table cellspacing="2" cellpadding="0">
 ...
 <?php foreach ($recieve->result() as $datum):?>
    ...
    <tr id="myinvitationrecievedclass<?php echo $datum->id; ?>" class="friend_listitem">
