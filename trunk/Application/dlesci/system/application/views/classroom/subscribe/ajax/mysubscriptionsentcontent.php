...
<input type="button" <?php if($page==0) echo 'style="visibility: hidden"'; ?> class="profile_button" value="previous" onclick="loadPage('classroom/mysubscriptionsentcontent/<?php echo ($page-1); ?>', 'list')"/>
            <span class="profile_label"><?php echo $page; ?></span>
            <input type="button" <?php if($page!=0) echo 'style="visibility: hidden"'; ?> class="profile_button" value="next" onclick="loadPage('classroom/mysubscriptionsentcontent/<?php echo ($page+1); ?>', 'list')"/>
</div>
    ...
    <tr>
        ...
        <td></td>
                 ...
                 <?php foreach ($sent->result() as $datum):?>
                    ...
                    <tr id="mysubscriptionsentclass<?php echo $datum->id; ?>" class="friend_listitem">
                        <td valign="middle">
